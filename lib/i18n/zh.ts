...
export const zh = {
  ...
  aboutPage: {
    ...
    editorialDesc: "我们的排名由固定算法生成，而非主观意见或联盟佣金决定。每本有声书都按同一套公式评分，与作者、出版商或佣金率无关。我们绝不收费收录或推广任何书目，联盟链接也不会影响书籍的价值评分。",
    methodologyTitle: "我们的方法论",
    methodologyDesc: "价值评分由公开数据——价格、时长、星级与评价数——通过上述公式计算得出。我们采用对数缩放的评价调整，使一本4.8星、10,000条评价的书不会被等同于仅12条评价的书。评分是决策辅助工具，不能替代试听样章。书籍数据通过Amazon Product Advertising API定期更新。",
    contactTitle: "纠错与联系",
    contactDesc: "发现数据错误或有想推荐的书？请发送邮件至hello@getcreditworth.com。我们每周处理纠错请求并相应更新数据集。",
  ...
  blogDetail: {
    ...
    viewTopBooks: "查看顶级书籍",
    trialCtaTopTitle: "免费开始听书",
    trialCtaTopSub: "30 天 Audible 免费试用，赠送 1 本有声书（价值约 $14.95），随时可取消。",
    trialCtaTopButton: "免费试用 Audible",
    trialCtaMidTitle: "准备好开始听这本书了吗？",
    trialCtaMidSub: "免费试用，用首张积分兑换任意书籍——永久保留。",
    trialCtaMidButton: "免费领取书籍",
    trialDisclaimer: "联盟链接——您无需额外付费，我们可能获得佣金。",
    recommendTitle: "编辑精选：最值得用积分的书",
    recommendSub: "按价值分排名——每美元听时最长、评分最高的书。",
  },
  curatedPage: {
    title: "精选有声书榜单",
  ...
  bookDetail: {
    ...
    recommendedCredit: "推荐：使用积分。", similarAudiobooksTitle: "值得用积分的相似有声书", creditVerdict: "积分结论", considerBuying: "建议：直接购买。",
